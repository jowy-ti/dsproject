...
\begin{document}
	...
	\begin{enumerate}
		\item \textbf{GOB Encoding Framework:} The system substitutes standard Recursive Length Prefix (RLP) \cite{wood2014ethereum} serialization for Go's native \texttt{GOB} binary encoder to natively streamline abstract interface polymorphism across node variations.
